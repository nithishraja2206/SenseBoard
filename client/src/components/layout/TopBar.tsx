  ...
  return (
    <header className="glass-panel border-b border-gray-800 px-6 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-5">
        {/* Current Mood Selector - Always displayed */}
          ...
          <Button 
            ...
            onClick={() => {
              if (projectId) {
                ...
                toast({
                  title: "Mood Set",
                  description: "You're feeling calm now. This will apply to your next project.",
                });
              }
            }} 
          ...
          <Button 
            ...
            onClick={() => {
              if (projectId) {
                ...
                toast({
                  title: "Mood Set",
                  description: "You're feeling energetic now. This will apply to your next project.",
                });
              }
            }} 
          ...
          <Button 
            ...
            onClick={() => {
              if (projectId) {
                ...
                toast({
                  title: "Mood Set",
                  description: "You're feeling focused now. This will apply to your next project.",
                });
              }
            }} 
            ...
            <DialogContent className="max-w-md">
                  ...
                  <Button 
                    ...
                    onClick={() => {
                      if (projectId) {
                        ...
                        toast({
                          title: "Mood Updated",
                          description: `You're feeling ${mood} now.`,
                        });
                      } else {
                        toast({
                          title: "Mood Set",
                          description: `You're feeling ${mood} now. This will apply to your next project.`,
                        });
                      }
                    }}
              ...
              <DialogFooter>
                <Button type="submit" onClick={() => {
                  toast({
                    title: "Mood Updated",
                    description: "Your mood has been saved. This will be visible to your team.",
                  });
                }}>Save Mood</Button>
              </DialogFooter>
            </DialogContent>
